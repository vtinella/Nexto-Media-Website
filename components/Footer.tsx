        ...
        <div className="grid md:grid-cols-4 gap-12">
          ...
          >
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-500 hover:text-navy-400 transition-colors">
          ...
          >
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/" className="text-gray-400 hover:text-navy-400 transition-colors text-sm">
                  Home
                </Link>
              </li>
              <li>
