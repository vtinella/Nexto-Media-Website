      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {images.map((image, index) => (
            ...
            >
              ...
              <div className="w-full h-full bg-gradient-to-br from-navy-100 via-gray-100 to-navy-50 group-hover:scale-105 transition-transform duration-500" />
        ...
        <div className="mt-12">
          <div className="relative overflow-hidden rounded-2xl aspect-video bg-gray-900">
            ...
            <div className="w-full h-full bg-gradient-to-br from-navy-950 to-gray-950 flex items-center justify-center">
              <div className="text-center text-white">
                <svg className="w-20 h-20 mx-auto mb-4 text-navy-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <p className="text-lg text-gray-400">Behind the Scenes Video</p>
              </div>
            </div>
          </div>
        </div>
